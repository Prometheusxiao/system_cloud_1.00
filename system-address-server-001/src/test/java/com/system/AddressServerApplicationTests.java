...
public class AddressServerApplicationTests {
    ...
    @Test
    public void jdsaidjasioojas(){
        List<AddressBasisInfo> addressBasisInfos = addressBasisInfoMapper.selectBySuperCode("110100000000");
        System.out.println(JsonUtils.objectToJson(addressBasisInfos));
    }
}
